...
var proppFunction1 = new Array("function 1: member(s) of family absents themselves from home = absentation (beta)",
"beta1 - absentation (departure) of elder(s)",
"beta2 - death of parent(s)",
"beta3 - absentation (departure) of sibling(s)");
var proppFunction2 = new Array("function 2: an interdiction is addressed to protagonist(s) = interdiction (gamma)",
"gamma1 - interdiction issued",
"gamma2 - inverted form of interdiction issued as order or suggestion");
var proppFunction3 = new Array("function 3: interdiction is violated = violation (delta)",
"delta1 - interdiction violated",
"delta2 - order or suggestion executed");
var proppFunction4 = new Array("function 4: antagonist(s) makes attempt at reconnaissance = reconnaissance (epsilon)",
...
var proppFunction5 = new Array("function 5: antagonist(s) receives information about victim(s) / protagonist(s) = delivery (zeta)",
...
var proppFunction6 = new Array("function 6: antagonist(s) attempts to deceive victim(s) / protagonist(s) in order to take possession of them or their belongings = trickery (eta)",
...
var proppFunction7 = new Array("function 7: victim(s) / protagonist(s) accept deception and unwittingly help antagonist(s) = complicity (theta/lamda)",
...
var proppFunction8 = new Array("function 8: antagonist(s) causes harm or injury to victim(s)/member of protagonist(s)'s family = villainy (A)",
...
var proppFunction8a = new Array("function 8a: one member of family lacks/desires something = lack (a)",
...
var proppFunction9 = new Array("function 9: misfortune/lack made known, protagonist(s) approached with request/command, they are allowed to go/dispatched = mediation, connective incident (B)",
...
var proppFunction10 = new Array("function 10: protagonist(s) agrees to or decides on counteraction = beginning counteraction (C)",
"C - protagonist(s) as seeker consents to counteraction");
var proppFunction11 = new Array("function 11: protagonist(s) leaves home = departure (up arrow)",
"up arrow - departure, dispatch of protagonist(s) from home");
var proppFunction12 = new Array("function 12: protagonist(s) tested, interogated, attacked, etc. which prepares way for receiving magical agent or helper = first function of donor (D)",
...
var proppFunction13 = new Array("function 13: protagonist(s) reacts to actions of future donor = protagonist(s)'s reaction (E)",
...
var proppFunction14 = new Array("function 14: protagonist(s) acquires use of magical agent = acquisition of magical agent (F)",
...
var proppFunction15 = new Array("function 15: protagonist(s) transferred, delivered or led to vicinity of object of search = transference, guidance (G)",
...
var proppFunction16 = new Array("function 16: protagonist(s) and antagonist(s) join in direct combat = struggle (H)",
"H1 - fight in an open battle",
"H2 - contest, competition",
"H3 - game of chance",
"H4 - weighing with scales");
var proppFunction17 = new Array("function 17: protagonist(s) branded = branding (J)",
"J1 - application of mark to body of protagonist(s) (wound, brand)",
"J2 - transference of token (ring, towel, etc.)");
var proppFunction18 = new Array("function 18: antagonist(s) defeated = victory (I)",
...
var proppFunction19 = new Array("function 19: initial misfortune or lack is liquidated = liquidation (K)",
...
var proppFunction20 = new Array("function 20: protagonist(s) returns = return (down arrow)",
"down arrow - return of protagonist(s)");
var proppFunction21 = new Array("function 21: protagonist(s) pursued = pursuit (Pr)",
...
var proppFunction22 = new Array("function 22: rescue of protagonist(s) from pursuit = rescue (Rs)",
...
var proppFunction23 = new Array("function 23: protagonist(s), unrecognized, arrives home or another country = unrecognized arrival (o)",
"o - unrecognized arrival");
var proppFunction24 = new Array("function 24: false protagonist(s) presents unfounded claims = unfounded claims (L)",
"L - claims of false protagonist(s)");
var proppFunction25 = new Array("function 25: difficult task proposed to protagonist(s) = difficult task (M)",
...
"M11 - sorting tasks",
"M12 - other tasks");
var proppFunction26 = new Array("function 26: task resolved = solution (N)",
...
var proppFunction27 = new Array("function 27: protagonist(s) recognized = recognition (Q)",
...
var proppFunction28 = new Array("function 28: false protagonist(s) or antagonist(s) exposed = exposure (Ex)",
...
var proppFunction29 = new Array("function 29: protagonist(s) given new appearance = transfiguration (T)",
...
var proppFunction30 = new Array("function 30: false protagonist(s) or antagonist(s) punished = punishment (U)",
"U - punishment of false protagonist(s) or antagonist(s)",
"U- - false protagonist(s) or antagonist(s) pardoned");
var proppFunction31 = new Array("function 31: protagonist(s) marries and ascends throne = wedding (W)",
